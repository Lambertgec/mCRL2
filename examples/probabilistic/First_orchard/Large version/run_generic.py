...
subprocess.run(['mcrl22lps', '-v', 'orchard_L.mcrl2', 'generic.lps'], check=True)
...
subprocess.run(['lps2pres', '-v', '-m', '-f', str(formula_dir / 'Min win large.mcf'),  'generic.lps', 'generic min win.pres'], check=True)
subprocess.run(['pressolve', '-am', '-p20', 'generic min win.pres'], check=True)
subprocess.run(['lps2pres', '-v', '-m', '-f', str(formula_dir / 'Min turns large.mcf'),  'generic.lps', 'generic min turns.pres'], check=True)
subprocess.run(['pressolve', '-am', '-p20', 'generic min turns.pres'], check=True)
subprocess.run(['lps2pres', '-v', '-m', '-f', str(formula_dir / 'Max turns large.mcf'),  'generic.lps', 'generic max turns.pres'], check=True)
